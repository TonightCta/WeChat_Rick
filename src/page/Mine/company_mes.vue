  ...
  <div class="person_mes">
    ...
    <div class="person_con">
      <ul class="mes_list">
        ...
        <li>
          <img src="../../../static/img/com_auth.png" alt="">
          <span>企业认证:</span>
          <span>
        ...
        <li>
          <img src="../../../static/img/com_ass.png" alt="">
          <span>企业评估:</span>
          <span>
        ...
        <li>
          <img src="../../../static/img/com_number.png" alt="">
          <span>技术人数:</span>
          <span>
            <input type="number" @blur="mesClear" v-model="userDate" name="" value=""
            placeholder="请输入企业技术人员人数" oninput="this.value=this.value.replace(/[^0-9.]+/,'');"
            >
            <span class="mes_mask" v-show="disabled"></span>
          </span>
        ...
        <li>
          <img src="../../../static/img/com_people.png" alt="">
          <span>联&nbsp;系&nbsp;人&nbsp;:</span>
          <span class="aaaaa">
            <input type="text" @blur="mesClear" v-model="cusName" name="" value=""
        ...
        <li>
          <img src="../../../static/img/com_field.png" alt="">
          <span>服务领域:</span>
          <br>
          <p class="aaaaa">
            <textarea name="name" rows="8" cols="80" placeholder="请输入企业服务领域" v-model="fieldText"></textarea>
            <span class="mes_mask last" v-show="disabled"></span>
          </p>
        </li>
      </ul>
...
export default {
  ...
  mounted(){
    ...
    if(this.userMes.engineerVO.peopleNumber){//工作年限
      this.userDate=this.userMes.engineerVO.peopleNumber;
    };
    if(this.userMes.engineerVO.linkName){//企业联系人
      this.cusName=this.userMes.engineerVO.linkName;
    };
    if(this.userMes.engineerVO.serviceScope){//企业服务领域
      this.fieldText=this.userMes.engineerVO.serviceScope;
    };
  ...
  methods:{
    ...
    saveMes(){//保存信息
      ...
      if(_vm.userDate==''){
        ...
        formData.append('linkName',_vm.cusName)
        formData.append('peopleNumber',_vm.userDate)
        formData.append('serviceScope',_vm.fieldText);
